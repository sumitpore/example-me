...
class View {
	...
	public static function render_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {
		...
		ob_start();
		do_action( 'example_me_before_template_render', $template_name, $template_path, $located, $args );
		include( $located );
		do_action( 'example_me_after_template_render', $template_name, $template_path, $located, $args );
	...
	public static function locate_template( $template_name, $template_path = '', $default_path = '' ) {
		if ( ! $template_path ) {
			$template_path = 'example-me-templates/';
		}
		if ( ! $default_path ) {
			$default_path = Example_Me::get_plugin_path() . 'app/templates/';
		}
		...
		if ( file_exists( $template ) ) {
			...
			return apply_filters( 'example_me_locate_template', $template, $template_name, $template_path );
		} else {
			return false;
		}
	}
