...
if ( ! class_exists( 'Example_Me' ) ) {
	 ...
	 */
	class Example_Me extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Example_Me    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Example_Me::PLUGIN_ID );
